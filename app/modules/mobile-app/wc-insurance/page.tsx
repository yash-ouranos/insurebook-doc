...
export const metadata: Metadata = {
  title: 'Add WC Insurance (Mobile App) | InsureBook Documentation',
  description:
    'Detailed user guide for the Add WC Insurance proposal form in the InsureBook mobile app: PDF auto-fill, client detail, WC insurance detail with number of workers and risk location, advance details, commission calculation, nominee and bank details, documents, and payment management.',
}
...
const toc = [
  ...
  { id: 'insurance-detail', label: '4. WC Insurance Detail' },
...
export default function MobileAppWcInsurancePage() {
  return (
    <DocsShell>
      {/* Breadcrumb */}
      ...
      <p className="mt-3 max-w-2xl text-base leading-relaxed text-muted-foreground text-pretty">
        The <strong className="text-foreground">Add WC Insurance</strong>{' '}
        form records Workmen&apos;s Compensation policies — cover that protects a
        business against liability for employee injury at work — from the
        phone. It follows the same structure as the other mobile policy forms
        while adding the WC-specific{' '}
        <strong className="text-foreground">No. of Worker</strong> and{' '}
      ...
      <figure className="mt-8 overflow-hidden rounded-lg border border-border bg-card">
        <div className="flex justify-center px-4 pt-4">
          <Image
            src="/screenshots/app-add-wc-insurance-1.jpg"
            alt="Add WC Insurance screen showing the Upload Policy PDF card with a Choose PDF button and 0/15 counter, the Client Detail section with Client Name, Policy Holder, and Sub Agent fields, the WC Insurance Detail section with insurance company, agency and broker codes, policy type, number of workers, policy number, booking, start and end dates, risk location, sum insured, net premium, GST percentage, and auto-calculated total premium, followed by the Advance Details section and the start of Commission Detail"
            width={1080}
            height={2160}
        ...
        <figcaption className="border-t border-border px-4 py-2.5 text-xs text-muted-foreground">
          The top of the Add WC Insurance form — PDF auto-fill, Client Detail,
          WC Insurance Detail, and Advance Details
        </figcaption>
      </figure>
      ...
      <div className="mt-12 flex flex-col gap-12">
        ...
        <DocSection id="overview" title="1. Overview">
          <p>
            ...
            by tapping the{' '}
            <strong className="text-foreground">WC Insurance</strong> card.
            The screen is titled{' '}
            <strong className="text-foreground">Add WC Insurance</strong> and
          ...
          <ul className="ml-5 list-disc space-y-1.5">
            ...
            <li>
              <strong className="text-foreground">WC Insurance Detail</strong>{' '}
              — company, codes, policy type, workers, number, dates, risk
        ...
        <DocSection id="upload-pdf" title="2. Upload Policy PDF (AI)">
          ...
          <Callout title="Always verify AI-filled data">
            ...
            the policy number, dates, worker count, and premium amounts
        ...
        {/* 4. WC Insurance Detail */}
        <DocSection id="insurance-detail" title="4. WC Insurance Detail">
          <p>
            The core of the proposal — the insurer, policy classification,
            worker count, policy number, dates, risk location, and premium.
          </p>
          <FieldTable
            caption="Fields in the WC Insurance Detail section"
            headers={['Field', 'Description']}
            rows={[
              [
          ...
          />
          <Callout type="info">
            Unlike Motor Insurance — which splits the premium into Own Damage
            and Third Party components with a GST amount — WC Insurance enters
            a single Net Premium and a GST percentage, the same as Life and
            Health.
          </Callout>
        </DocSection>
        ...
        <DocSection id="commission-detail" title="6. Commission Detail">
          <p>
            ...
            over from the WC Insurance Detail section, so you can see the base
          ...
          <figure className="mt-2 overflow-hidden rounded-lg border border-border bg-card">
            <div className="flex justify-center px-4 pt-4">
              <Image
                src="/screenshots/app-add-wc-insurance-2.jpg"
        ...
        <DocSection id="policy-documents" title="8. Policy & Upload Document">
          ...
          <ul className="ml-5 list-disc space-y-1.5">
            ...
            <li>
              ...
              to attach supporting files such as the wage register, employee
              list, or previous policy. Repeat to add more.
            </li>
          </ul>
        </DocSection>
        ...
        <DocSection id="payment-management" title="9. Payment Management">
          ...
          <figure className="mt-2 overflow-hidden rounded-lg border border-border bg-card">
            <div className="flex justify-center px-4 pt-4">
              <Image
                src="/screenshots/app-add-wc-insurance-3.jpg"
                alt="End of the Payment Management section showing the Payment Method dropdown set to UPI, an empty Next Premium Date picker, a Note textarea with the placeholder Enter payment note, and the purple Submit button at the bottom of the form"
                width={1080}
                height={1551}
                className="w-full max-w-xs rounded-lg border border-border"
              />
          ...
          <StepList
            steps={[
              ...
              <>
                ...
                the WC Insurance list on both the app and the web portal.
              </>,
            ]}
          />
        </DocSection>
